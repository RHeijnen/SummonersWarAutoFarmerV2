 ...
 */
public class DungeonFarmingLogic extends TimerTask implements GeneralFarmLogic {
    ...
    public void checkVictory() {
        ...
        /*
        if(victoryScreenData.getColorCountWithOffset(254,205,23,10) > 200 ){
            System.out.println("victory screen");
            int mousePosition[] = victoryScreenData.getCenterLocationOfRectangleWithRandomOffset(10);
            robo.mouseMove(mousePosition[0],mousePosition[1]);
            robo.delay(100);
    ...
    public void checkReplay() {
        /*
            if (replayButtonData.getColorCountWithOffset(25, 16, 17, 10) > 300) {
                bool_ReplayPressed = true;
                bool_BattlePressed = false;
                System.out.println(replayButtonData.getColorCountWithOffset(25, 16, 17, 10));
    ...
    public void run() {
        ...
        if (active) {
            if (!bool_farmWithRefill) {
                System.out.println(lootButtonOKData.getSelectionPixelDifference());
                System.out.println(startBattleButtonData.getSelectionPixelDifference());
